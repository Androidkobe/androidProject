...
class Collection4DemoFragment : Fragment() {
    private lateinit var demoCollectionPagerAdapter: DemoCollection4PageAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        demoCollectionPagerAdapter = DemoCollection4PageAdapter(this)
