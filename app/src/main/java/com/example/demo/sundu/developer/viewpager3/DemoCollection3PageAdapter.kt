...
class DemoCollection3PageAdapter(fm: Fragment) : FragmentStateAdapter(fm) {
    ...
    override fun createFragment(position: Int): Fragment {
        ...
        val fragment = DemoObject3Fragment()
    ...
    override fun onBindViewHolder(
        ...
        var fragment = getItem(position) as DemoObject3Fragment
