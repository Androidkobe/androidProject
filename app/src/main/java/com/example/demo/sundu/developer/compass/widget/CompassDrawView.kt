package com.example.demo.sundu.developer.compass.widget

import android.content.Context
import android.graphics.*
import android.util.AttributeSet
import android.view.View
import com.example.demo.sundu.developer.compass.utils.DensityUtils
...
class CompassDrawView : View {
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        mRadius =
            (Math.min(w - paddingLeft - paddingRight, h - paddingTop - paddingBottom) / 2).toFloat()
    ...
    private fun drawDirectionText() {
        ...
        mCanvas.drawText(
            ...
            width / 2 + getXx(
                width / 2 - offset,
                (0 + mDirection).toInt()
            ).toFloat() - textSmallWidth / 2,
            height / 2 - getYy(
                width / 2 - offset,
                (0 + mDirection).toInt()
            ).toFloat() + mTextRect.height() / 2,
            mTextPaint
        )
    ...
    private fun drawAngleText() {
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (0 + mDirection).toInt()).toFloat() - textSmallWidth / 2,
            height / 2 - getYy(circleR, (0 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (30 + mDirection).toInt()).toFloat() - textMiddleWidth / 2,
            height / 2 - getYy(circleR, (30 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (60 + mDirection).toInt()).toFloat() - textMiddleWidth / 2,
            height / 2 - getYy(circleR, (60 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (90 + mDirection).toInt()).toFloat() - textMiddleWidth / 2,
            height / 2 - getYy(circleR, (90 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (120 + mDirection).toInt()).toFloat() - textLargeWidth / 2,
            height / 2 - getYy(circleR, (120 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (150 + mDirection).toInt()).toFloat() - textLargeWidth / 2,
            height / 2 - getYy(circleR, (150 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (180 + mDirection).toInt()).toFloat() - textMiddleWidth / 2,
            height / 2 - getYy(circleR, (180 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (210 + mDirection).toInt()).toFloat() - textLargeWidth / 2,
            height / 2 - getYy(circleR, (210 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (240 + mDirection).toInt()).toFloat() - textLargeWidth / 2,
            height / 2 - getYy(circleR, (240 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (270 + mDirection).toInt()).toFloat() - textLargeWidth / 2,
            height / 2 - getYy(circleR, (270 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (300 + mDirection).toInt()).toFloat() - textLargeWidth / 2,
            height / 2 - getYy(circleR, (300 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
        ...
        mCanvas.drawText(
            timeText,
            width / 2 + getXx(circleR, (330 + mDirection).toInt()).toFloat() - textLargeWidth / 2,
            height / 2 - getYy(circleR, (330 + mDirection).toInt()).toFloat() + textHeight / 2,
            mTextPaint
        )
