...
class Builder(
    ...
    inline fun <reified D : Any, reified H : RecyclerView.ViewHolder> addType(
        ...
        content.types[D::class.java as Class<Any>] =
            ItemType(resId, func as BindFunc<Any, RecyclerView.ViewHolder>?)
     ...
     */
    @Suppress("UNCHECKED_CAST")
    inline fun <reified D : Any, reified H : RecyclerView.ViewHolder> addHeader(
        header: D,
        resId: Int,
        func: BindFunc<D, H>? = null
    ) {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    inline fun <reified D : Any> addHeader(
        header: D,
        resId: Int,
        func: BindFunc<D, ViewHolderX>? = null
    ): Int {
        content.headers.add(header)
        content.types[D::class.java as Class<Any>] =
            ItemType(resId, func as BindFunc<Any, RecyclerView.ViewHolder>?)
     ...
     */
    @Suppress("UNCHECKED_CAST")
    inline fun <reified D : Any, reified H : RecyclerView.ViewHolder> addFoot(
        foot: D,
        resId: Int,
        func: BindFunc<D, H>? = null
    ) {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    inline fun <reified D : Any> addFoot(
        foot: D,
        resId: Int,
        func: BindFunc<D, ViewHolderX>? = null
    ): Int {
 ...
 * @since 0.6.0
 */
val RecyclerView.adapterX: AdapterX
    get() {
        val adapter = adapter
