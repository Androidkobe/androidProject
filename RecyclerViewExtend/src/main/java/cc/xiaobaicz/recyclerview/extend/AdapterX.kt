 ...
 */
class AdapterX(context: Context, val content: Content) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val holderClazz = content.holderTypes[viewType]
            ?: throw NullPointerException("view holder can not be empty")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    private fun <D : Any, H : RecyclerView.ViewHolder> bind(
        d: D,
        viewHolder: H,
        position: Int,
        bindFunc: BindFunc<D, H>?,
        payloads: MutableList<Any>
    ) {
